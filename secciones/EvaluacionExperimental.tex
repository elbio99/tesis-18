...
En este capitulo se expondrá los resultados que se obtuvieron por medio de los experimentos realizados en este trabajo de investigación. Los pasos seguidos serán presentados dividiendo en diferentes secciones para lograr una mayor comprensión del trabajo por parte del lector.

La primera sección \textit{Preparación de Datos} \ref{sec:preparacion_de_datos}, se muestran cuales fueron los recursos finales que se utilizaron para realizar los experimentos.

La segunda sección  \textit{Entrenamiento y Validación} \ref{sec:entrenamiento}, se detallan como se realizo el proceso de aprendizaje de los datos y los procesos de validación que se llevaron a cabo.
