...
En este capitulo se expondrá los resultados obtenidos a partir de los experimentos realizados. Los pasos seguidos serán presentados dividiendo en diferentes secciones para lograr una mayor comprensión del trabajo.

La primera sección \textit{Preparación de Datos} \ref{sec:preparacion_de_datos}, se desarrollan cuales son los recursos que se utilizaron para realizar la experimentación.
