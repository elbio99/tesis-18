...
Para este proceso se utilizó una red pre-entrenada \textbf{ResNet50}\ref{sub:arquitecturacnn} \ref{chap:pipeline}donde se obtuvo de la ante ultima capa el vector que va a representar la región.
