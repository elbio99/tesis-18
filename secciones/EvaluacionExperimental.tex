...
%En este capítulo se desarrollará como se realizo el proceso de aprendizaje de los datos y los procesos de validación que se llevaron a cabo; a su vez se detallan las métricas obtenidas de cada modelo entrenado.
...
%Para validar los modelos utilizamos las métricas desarrolladas en la sección \ref{sub:evaluación-modelo}, la evaluación de la detección utilizamos \textit{IoU}, intersección sobre unión,  en esta métrica comparamos los bounding boxes predichos y el ground thruth etiquetado. Este valor nos da una visión de cual es la exactitud de nuestro modelo en cuanto a la localización del objeto.


%\subsection*{Resultados obtenidos}\label{sub:resultado_obtenidos}
...
\begin{figure}[H]\centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/ROC153.png}
  \caption{Average precision, bandas 1-5-3} \label{Fig:ROC153}
\end{figure}
\begin{figure}[H]\centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/AP9711.png}
 \caption{Average precision, bandas 9-7-11} \label{Fig:AP9711}
\end{figure}
 \begin{figure}[H]\centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/ROC1075.png}
  \caption{Average precision, bandas 10-7-5} \label{Fig:AP1075}
\end{figure}

 \begin{figure}[H]
 \centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/1-5-3.png}
  \caption{Combinación de bandas 1-5-3} \label{Fig:imagen_banda_153}
\end{figure}
 
 \begin{figure}[H]
 \centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/9-7-11.png}
  \caption{Combinación de bandas 9-7-11} \label{Fig:imagen_banda_9711}
\end{figure}

  \begin{figure}[H]
 \centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/10-7-5.png}
...
El principal inconveniente detectado en todos los modelos entrenados con las diferentes combinaciones de bandas fue las nubes en las imágenes, la mayoría de los \textit{falsos positivos} detectados se debió a la parecencia de las misma, por otro lado se observa en la tabla \ref{tab:entrenam-result} que las combinaciones de bandas que mayor métricas dieron fueron aquellas que de alguna manera se podía distinguir y resaltar el suelo, agua y nubes, esto se puede ver reflejado en las bandas  \textbf{1-1-1} (fig: \ref{Fig:imagen_banda_111}) en donde no se puede distinguir las regiones de interés dentro de la misma. 
 ...
 \begin{figure}[H]\centering
  \includegraphics[height=10cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/1-1-1.png}
...
\begin{figure}[H]\centering
  \includegraphics[height=7cm,keepaspectratio=true,clip=true]{imagenes/evaluacion/prediction-9711.png}
