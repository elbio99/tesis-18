...
El \textbf{Capítulo} \ref{chap:esquema_de_deteccion} \textit{Esquema de Detección}: En este capítulo se describen el esquema de procesamiento (pipeline) utilizado para el desarrollo de la tesis, también se desarrollará la \textit{recolección de datos} llevada a cabo para la obtención de las imágenes.
