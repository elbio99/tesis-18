...
El capítulo \ref{chap:evaluacion} \textit{Evaluación experimental}:  se  dividió en tres secciones principales. La primera hace referencia a los datos y procesos que se llevaron a cabo sobre las imágenes. La segunda parte se describe como se extrajo los datos de cada imagen para realizar el entrenamiento. En la sección final del capítulo se describen los métodos de validación utilizados y cuáles fueron los resultados obtenidos.
