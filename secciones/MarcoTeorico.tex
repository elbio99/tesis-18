...
\caption{(a) ejemplo de sliding windows en donde el bboxs (recuadro en color rojo) recorre la imagen de izquierda a derecha y desde arriba a abajo dando pasos de $N$ píxeles, (b) ejemplo de piramide de resolución}\label{Fig:sliding}
\end{figure}
