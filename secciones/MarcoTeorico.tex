...
Existen diversos métodos para calcular regiones candidatas que podemos encontrar en: \citep{proposal}. En este trabajo se realizo pruebas con los  Edges Boxes, BING y Selective Search.
...
\ac{nms} es un pre-procesamiento muy importante en el ámbito de \ac{cv}  donde trabajamos con imágenes de alta resolución \citep{nms}.  \ac{nms} normalmente se usa con algoritmos de detección de bordes \textit{Edge Boxes} .
