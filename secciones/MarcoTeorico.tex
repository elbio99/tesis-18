...
\subfigure[Resolución espectral ]{\includegraphics[width=6.6cm,height=5.2cm]{imagenes/MarcoTeorico/resolucion_espectral.jpg}}
...
La idea principal de desarrollar un modelo; es crear un algoritmo que a partir de datos encuentre automáticamente una frontera, clasifique, encuentre por ejemplo una frontera entre los puntos negros y los puntos blancos.Como se puede ver en la figura \ref{Fig:ejemplo-2}, se muestra la frontera de separación creada por el algoritmo entrenado.
