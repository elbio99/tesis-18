...
\begin{figure}[H]
 \centering
  ...
  \caption{Ejemplo Bosques Aleatorios \\ https://www.researchgate.net/publication/324517994}
  \label{Fig: random_forest}
\end{figure}

\par \textbf{Maquina de vectores de soporte (SVM por su siglas en ingles)}: El objetivo de un algoritmo \ac{svm} es encontrar un hiperplano en un espacio de $n$ dimensiones que separe los datos con el mayor margen posible, como en la figura \ref{Fig: margenseparacionsvm}. 
