...
Debido a la complejidad de los nuevos desafios a solucionar las técnicas de \ac{cv} y \ac{ml} se intersectan; de esta manera \ac{cv}  se convirtio en en unos de los dominio principales en los que se han aplicado con exito metodos de \ac{ml} por ejemplo reconocer objetos en una imagen. 
...
Las aplicaciónes de mayormente utilizadas son: reconocimiento de imágenes, analisis de video, procesamiento de lenguaje natural, detección de poses, segmentación de imagenes, entre otros.
