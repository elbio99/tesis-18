...
\caption{(a) Matriz de entrada y filtro de convolución (b) Operación de convolución.}\label{Fig:filter}
\end{figure}
...
\begin{figure}[H]
 \centering
  ...
  \caption{Arquitectura VGG.}
  %\\ (Adaptado de: \citep{vgg}).}
	\label{Fig:vgg}
\end{figure}
