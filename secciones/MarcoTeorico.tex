...
El método de supresión de no máximos (NMS) es un post-procesamiento muy importante en el contexto de la detección. El algoritmo  \ac{nms} se encarga de eliminar regiones que estén superpuestas entre si como se muestra en la figura  \ref{Fig: overlapping}.
