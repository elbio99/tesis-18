...
\begin{figure}[H] \centering
  ...
  \caption{Regiones propuestas, \citep{regions_proposal_gr}.}
...
\begin{figure}[H]
 \centering
  ...
  \caption{Segmentación por el metodo de \textit{Selective Search} con diferentes valores de umbrales \\ \citep{selectivesearch}.}
